...
public:
	...
	void analyze(istringstream i_stream)
	{
		int new_up, new_down, v;
		char c;
		i_stream >> new_down >> c >> new_up >> c >> v >> c;
		animate(new_up, new_down, v);
	}
...
class Oczy : public FacePart
{
private:
	vector<shared_ptr<Oko>> oczy;
...
public:
	...
	void analyze(istringstream i_stream)
	{
		int new_up, new_down, new_side, v;
		char c;
		i_stream >> new_down >> c >> new_up >> c >> new_side >> c >> v >> c;
		animate(new_up, new_down, new_side, v);
	}
